...
The original datasets is available at [here](https://www.kaggle.com/datasets/jboysen/mri-and-alzheimers).

# Dataset Overview & Structure

The OASIS published two datasets: a Cross-sectional MRI database and a Longitudinal MRI database, each consisting of distinct groups of subjects. Both datasets include demographic, cognitive, and neuroimaging measures that have been widely studied as biomarkers of Alzheimer’s disease.
